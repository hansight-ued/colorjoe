...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('onecolor')) :
	typeof define === 'function' && define.amd ? define(['onecolor'], factory) :
	(global.colorjoe = factory(global.one));
}(this, (function (one) { 'use strict';

	one = one && one.hasOwnProperty('default') ? one['default'] : one;
